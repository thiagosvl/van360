...
export default function ConfigurarRota() {
  ...
  const onSave = () => {
    form.handleSubmit(
      ...
      () => {
        toast.error("Formulário com erros. Verifique os campos destacados.");
      }
    )();
  };
          ...
          <Card className="p-5 border-slate-150/60 shadow-sm rounded-[1.25rem] bg-white/60 backdrop-blur-md space-y-4">
            <div className="grid gap-4 sm:grid-cols-2">
                ...
                render={({ field, fieldState }) => (
                  <FormItem className="space-y-2">
                    <FormLabel className="text-slate-700 font-semibold ml-1">
                      Nome da Rota <span className="text-red-600">*</span>
                    </FormLabel>
                    <FormControl>
                      <div className="relative">
                        <Route className={cn(
                          "absolute left-4 top-3.5 h-5 w-5 text-slate-400 opacity-60 transition-colors",
                          fieldState.error && "text-red-400 opacity-100"
                        )} />
                        <Input
                          {...field}
                          id="nome-rota"
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="space-y-2">
                    <FormLabel className="text-slate-700 font-semibold ml-1">Período <span className="text-red-600">*</span></FormLabel>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem className="space-y-2">
                    <FormLabel className="text-slate-700 font-semibold ml-1">Tipo de Trajeto <span className="text-red-600">*</span></FormLabel>
                    <FormControl>
                      <div className="bg-slate-100/80 p-1 rounded-xl">
                        <Tabs value={field.value} onValueChange={field.onChange} className="w-full">
          ...
          <div className="grid gap-6 md:grid-cols-5 items-start">
            ...
            <div className="md:col-span-3 space-y-4">
              ...
              <div className="space-y-2.5">
                {form.formState.errors.passageiros && (
                  <div className="bg-red-50 border border-red-200/50 rounded-2xl p-3.5 flex items-start gap-3 text-red-700 animate-in fade-in slide-in-from-top-2 duration-300">
                    <div className="bg-red-100 p-1.5 rounded-lg text-red-600 shrink-0">
                      <AlertCircle className="w-4 h-4" />
                    </div>
                    <div className="space-y-0.5">
                      <h4 className="text-[11px] font-bold uppercase tracking-wider text-red-800">Atenção</h4>
                      <p className="text-[10px] font-medium leading-relaxed">
                        {form.formState.errors.passageiros.message}
                      </p>
                    </div>
                  </div>
                )}
                ...
                <div className="bg-amber-500/5 border border-amber-500/10 rounded-2xl p-3.5 flex items-start gap-3">
                  ...
                  <div className="space-y-0.5">
                    ...
                    <p className="text-[10px] text-amber-700/85 font-medium leading-relaxed">
                      Para organizar a sequência do trajeto, segure e arraste os cards dos passageiros na ordem desejada ou utilize as setas rápidas de subida e descida.
                    </p>
                  </div>
                </div>
                ...
                {selectedPassengers.length === 0 ? (
                  <div className="bg-slate-100/50 border border-dashed border-slate-200/60 rounded-2xl p-8 flex flex-col items-center justify-center text-center space-y-2">
                    ...
                    <p className="text-[10px] text-slate-400/80 font-semibold max-w-[240px]">
                      Toque em "+" na lista de passageiros abaixo para adicionar passageiros e definir a ordem do trajeto.
                    </p>
                  </div>
                ) : (
