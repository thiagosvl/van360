            ...
            <div className="flex items-center gap-4 min-w-0">
              ...
              <div className="min-w-0">
                ...
                <p className="text-xs text-slate-500 leading-relaxed">
                  Seus dados cadastrais, apelido da van e informações de contato
                </p>
              </div>
            </div>
    ...
    <div className="max-w-4xl mx-auto space-y-6 pt-2 sm:pt-6 pb-12">
      ...
      {isSubPage && (
        <button
          ...
          className="inline-flex items-center gap-2 text-xs sm:text-sm font-semibold text-slate-600 hover:text-[#1a3a5c] transition-colors group w-fit"
        >
