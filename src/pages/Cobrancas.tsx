          ...
          >
            ...
            <TabsContent value="pendentes" className="mt-0">
              <ResponsiveDataList
                ...
                emptyState={(() => {
                  const hasAnyCobrancaInMonth =
                    cobrancasAbertas.length + cobrancasPagas.length > 0;
                  ...
                  if (!hasAnyCobrancaInMonth) {
                    ...
                    return (
                      <UnifiedEmptyState
                        ...
                        description={`Ainda não há cobranças registradas em ${
                          meses[mesFilter - 1]
                        }.`}
                      />
                    );
                  ...
                  return (
                    <UnifiedEmptyState
                      icon={CheckCircle2}
                      title="Tudo certo!"
                      description={`Todas as cobranças de ${
                        meses[mesFilter - 1]
                      } já foram pagas!`}
              ...
              <ResponsiveDataList
                ...
                emptyState={
                  <UnifiedEmptyState
                    ...
                    description={
                      buscaPagas === ""
                        ? `Não há cobranças pagas registradas em ${
                            meses[mesFilter - 1]
                          }.`
