...
const LatePaymentsAlert = ({
  ...
  const handleEnviarNotificacaoClick = (
    cobrancaId: string,
    nomePassageiro: string
  ) => {
  ...
  const handleConfirmEnvioNotificacao = () => {
    onEnviarNotificacaoCobranca(
      confirmDialog.cobrancaId,
      confirmDialog.nomePassageiro
    );
    ...
    return (
      <div className="mb-6 flex items-center gap-3 rounded-lg border border-green-200 bg-green-50 p-4">
        ...
        <div className="text-sm font-medium text-green-800">
          Não há mensalidades pendentes em {monthNames[selectedMonth - 1]}!
        </div>
      </div>
    );
  }
  ...
  return (
    <>
                    ...
                    <td className="p-3 text-center align-top">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent>
                          ...
                          <DropdownMenuItem onClick={() => onPayment(cobranca)}>
                            Registrar Pagamento
                          </DropdownMenuItem>
                          <DropdownMenuItem
                    ...
                    <div className="flex justify-between items-start">
                      <div className="pr-2">
                        ...
                        <div className="text-sm text-muted-foreground">
                          Resp: {cobranca.passageiros.nome_responsavel || "-"}
                        </div>
                      </div>
                      <DropdownMenu>
                        <DropdownMenuTrigger asChild>
        ...
        {visibleCount < sortedLatePayments.length && (
          <CardFooter className="flex-col items-center py-4 bg-white border-t md:bg-transparent">
            ...
            <p className="text-xs text-muted-foreground mt-2">
              Exibindo {visibleCount} de {sortedLatePayments.length}
            </p>
          </CardFooter>
        )}
      </Card>
      ...
      <ConfirmationDialog
        ...
        onConfirm={handleConfirmEnvioNotificacao}
      />
    </>
  );
};
