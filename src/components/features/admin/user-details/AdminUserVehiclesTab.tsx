    ...
    <Card className="border-0 shadow-diff-shadow rounded-[2rem] overflow-hidden bg-white">
      <CardHeader className="p-6">
        <CardTitle className="text-sm font-headline font-black text-[#1a3a5c] uppercase tracking-tight flex items-center gap-2">
          <Bus className="h-4 w-4 text-[#1a3a5c]" />
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h4 className="text-sm font-headline font-bold text-slate-800 uppercase leading-tight">
                        {v.modelo}
                      </h4>
                  ...
                  <Badge variant={v.ativo ? "default" : "secondary"} className="text-[9px] uppercase px-2 py-0.5">
                ...
                <div className="pt-3 border-t border-slate-200/60 text-xs">
                  <div>
                    <span className="text-[9px] font-black text-slate-400 uppercase tracking-widest block">Marca</span>
                    <span className="font-bold text-slate-700 block">{v.marca || "Não informada"}</span>
                  </div>
                </div>
              </div>
            ))}
