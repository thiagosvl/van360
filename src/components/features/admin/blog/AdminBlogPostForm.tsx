  ...
  const handleMagicFill = () => {
    ...
    if (editor && !editor.isDestroyed) {
      const htmlStr = `<h2>Como otimizar a sua rotina diária no transporte escolar</h2>
        ...
        <p>Utilize ferramentas como o <strong>Van360</strong> para gerenciar seus alunos, pagamentos de parcelas, cobranças, controle de alunos e rotas escolares de forma centralizada e profissional!</p>`;
