...
export function MinhaEquipeTab() {
  ...
  return (
    <div className="space-y-6">
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full space-y-6">
        {/* Padrão Exato de Tabs da Tela de Passageiros */}
      ...
      {/* Modal Redefinir Senha (BaseDialog) */}
      <BaseDialog
      ...
      {/* Modal de Confirmação de Alteração de Status (BaseDialog) */}
      <BaseDialog
      ...
      {/* Modal de Confirmação de Exclusão Física (BaseDialog) */}
      <BaseDialog
