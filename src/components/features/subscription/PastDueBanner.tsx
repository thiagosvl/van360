    ...
    <div className="mb-6 bg-rose-50 border border-rose-200 rounded-2xl p-4 flex flex-col sm:flex-row items-start sm:items-center gap-4 animate-in fade-in slide-in-from-top-2 duration-500">
      ...
      {onRegularize ? (
        <button
          ...
          className="px-4 py-2 bg-rose-600 text-white text-[11px] font-bold rounded-xl hover:bg-rose-600/90 transition-all shadow-sm shadow-rose-200 shrink-0 active:scale-95 w-full sm:w-auto text-center flex justify-center"
        >
          Regularizar
        </button>
      ) : (
        <div className="px-4 py-2 bg-rose-600/50 text-white text-[11px] font-bold rounded-xl shrink-0 opacity-50 w-full sm:w-auto text-center flex justify-center">
          Regularizar
        </div>
      )}
    </div>
