      ...
      <div className="p-4 flex items-end justify-between gap-4">
        <div className="flex flex-col gap-0.5">
          ...
          <div className="flex items-baseline gap-1">
            ...
            <span className="text-3xl font-bold text-gray-900 tracking-tighter leading-none">
              {currentPrice !== null
        ...
        {activeTab === PLANO_ESSENCIAL ? (
          ...
          <Button
            className="h-12 px-6 bg-violet-600 hover:bg-violet-700 text-white font-bold rounded-xl shadow-md shadow-violet-200/50 transition-all text-sm mb-0"
