...
export const messages = {
  ...
  erro: {
    ...
    validacao: {
      ...
      selecionePassageiro: "Selecione um aluno para continuar.",
    },
  },
  ...
  veiculo: {
    erro: {
      ...
      excluirComPassageiros: "Existem alunos vinculados a este veículo.",
      desativar: "Não é possível desativar.",
      desativarComPassageiros: "Existem alunos ativos vinculados a este veículo.",
  ...
  passageiro: {
    erro: {
      carregar: "Erro ao carregar alunos.",
      criar: "Erro ao cadastrar aluno.",
      atualizar: "Erro ao atualizar aluno.",
      excluir: "Erro ao excluir aluno.",
      naoEncontrado: "Aluno não encontrado.",
      excluirComCobrancas: "Este aluno possui parcelas em seu histórico.",
      ativar: "Erro ao ativar o aluno.",
      desativar: "Erro ao desativar o aluno.",
      alterar: "Erro ao buscar alterar aluno.",
      criarDetalhe: "Não foi possível criar o aluno.",
      atualizarDetalhe: "Não foi possível atualizar o aluno.",
      excluirDetalhe: "Não foi possível excluir o aluno.",
    ...
    sucesso: {
      criado: "Aluno cadastrado com sucesso.",
      atualizado: "Aluno atualizado com sucesso.",
      excluido: "Aluno excluído com sucesso.",
      ativado: "Aluno ativado com sucesso.",
      desativado: "Aluno desativado com sucesso.",
  ...
  escola: {
    erro: {
      ...
      excluirComPassageiros: "Existem alunos vinculados a esta escola.",
      desativar: "Não é possível desativar.",
      desativarComPassageiros: "Existem alunos ativos vinculados a esta escola.",
  ...
  cobranca: {
    erro: {
      ...
      naoEncontrada: "Parcela não encontrada.",
      naoEncontradaDescricao: "Não foi possível encontrar a parcela pendente. Por favor, recarregue a página.",
      carregarPagamento: "Erro ao carregar pagamento.",
      listarAno: "Erro ao listar parcelas para o ano selecionado.",
      processarAcao: "Erro ao processar a ação.",
      linkPagamentoIndisponivel: "Link de pagamento indisponível.",
      jaExiste: "Já existe uma parcela registrada para o mês e ano selecionado.",
      selecioneFormaPagamento: "Selecione uma forma de pagamento.",
      criarEnviada: "Parcela registrada e enviada com sucesso!",
      criarSucesso: "Parcela registrada com sucesso!",
      criarDetalhe: "Não foi possível registrar a parcela.",
      atualizarDetalhe: "Não foi possível atualizar a parcela.",
      excluirDetalhe: "Não foi possível excluir a parcela.",
      cancelar: "Erro ao cancelar parcela.",
      cancelarDetalhe: "Não foi possível cancelar a parcela.",
      reativar: "Erro ao reativar parcela.",
      reativarDetalhe: "Não foi possível reativar a parcela.",
    ...
    sucesso: {
      criada: "Parcela registrada com sucesso.",
      atualizada: "Parcela atualizada com sucesso.",
      excluida: "Parcela excluída com sucesso.",
      cancelada: "Parcela cancelada com sucesso.",
      reativada: "Parcela reativada com sucesso.",
  ...
  auth: {
    erro: {
      ...
      nenhumPassageiroEncontrado: "Nenhum aluno foi encontrado vinculado aos dados informados.",
    },
    sucesso: {
  ...
  validacao: {
    ...
    selecionePassageiro: "Selecione um aluno.",
  },
  ...
  home: {
    info: {
      ...
      passageirosEmAtraso: "aluno(s) em atraso",
    },
  },
