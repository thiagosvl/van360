export const DEFAULT_CLAUSULAS_CONTRATO = [
  ...
  "As parcelas deverão ser pagas até o dia estabelecido nas CONDIÇÕES DE VALOR, durante todo o período de vigência do contrato. Em caso de atraso no pagamento, a CONTRATANTE poderá estar sujeita à multa e juros previstos nas CONDIÇÕES DE VALOR.",
  "Início do ano terá reajuste do valor das parcelas e um novo contrato será emitido.",
