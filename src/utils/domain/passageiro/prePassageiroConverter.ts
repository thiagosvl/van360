...
export function mapearPrePassageiroParaFormulario(pre: PrePassageiro): Partial<PassageiroFormData> {
  return {
    ...
    responsavel_principal: {
      ...
      cpf: pre.cpf_responsavel ? cpfMask(pre.cpf_responsavel) : "",
      telefone: pre.telefone_responsavel ? phoneMask(pre.telefone_responsavel) : "",
      email: pre.email_responsavel || "",
      parentesco: pre.parentesco_responsavel || "",
