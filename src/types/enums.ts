...
export enum NotificationEventEnum {
  PASSAGEIRO_VENCIMENTO_PROXIMO = "PASSAGEIRO_VENCIMENTO_PROXIMO",
  PASSAGEIRO_VENCIMENTO_HOJE = "PASSAGEIRO_VENCIMENTO_HOJE",
  PASSAGEIRO_ATRASADO = "PASSAGEIRO_ATRASADO",
  PASSAGEIRO_CONTRATO_DISPONIVEL = "PASSAGEIRO_CONTRATO_DISPONIVEL",
  PASSAGEIRO_CONTRATO_ASSINADO = "PASSAGEIRO_CONTRATO_ASSINADO",
  PASSAGEIRO_RENOVACAO_DISPONIVEL = "PASSAGEIRO_RENOVACAO_DISPONIVEL",
  PASSAGEIRO_RECIBO_PAGAMENTO = "PASSAGEIRO_RECIBO_PAGAMENTO",
  PASSAGEIRO_PIN_RESET = "PASSAGEIRO_PIN_RESET",

  ROTA_INICIADA_IDA = "ROTA_INICIADA_IDA",
  ROTA_A_CAMINHO_IDA = "ROTA_A_CAMINHO_IDA",
  ROTA_EMBARCOU_IDA = "ROTA_EMBARCOU_IDA",
  ROTA_DESFEITO_EMBARQUE_IDA = "ROTA_DESFEITO_EMBARQUE_IDA",
  ROTA_INICIADA_VOLTA = "ROTA_INICIADA_VOLTA",
  ROTA_A_CAMINHO_VOLTA = "ROTA_A_CAMINHO_VOLTA",
  ROTA_DESEMBARCOU_VOLTA = "ROTA_DESEMBARCOU_VOLTA",
  ROTA_DESFEITO_DESEMBARQUE_VOLTA = "ROTA_DESFEITO_DESEMBARQUE_VOLTA",
  ROTA_REORDENADA = "ROTA_REORDENADA",

  MOTORISTA_TESTE_BOAS_VINDAS = "MOTORISTA_TESTE_BOAS_VINDAS",
  MOTORISTA_TESTE_ENCERRADO = "MOTORISTA_TESTE_ENCERRADO",
  MOTORISTA_TRIAL_D14_ULTIMO_AVISO = "MOTORISTA_TRIAL_D14_ULTIMO_AVISO",
  MOTORISTA_TRIAL_BONUS_INATIVO = "MOTORISTA_TRIAL_BONUS_INATIVO",
  MOTORISTA_TRIAL_RECUPERACAO_1 = "MOTORISTA_TRIAL_RECUPERACAO_1",
  MOTORISTA_TRIAL_RECUPERACAO_2 = "MOTORISTA_TRIAL_RECUPERACAO_2",

  MOTORISTA_ASSINATURA_PAGO = "MOTORISTA_ASSINATURA_PAGO",
  MOTORISTA_ASSINATURA_VENCENDO = "MOTORISTA_ASSINATURA_VENCENDO",
  MOTORISTA_ASSINATURA_VENCEU = "MOTORISTA_ASSINATURA_VENCEU",
  MOTORISTA_ASSINATURA_ATRASADA = "MOTORISTA_ASSINATURA_ATRASADA",
  MOTORISTA_ASSINATURA_FALHA_CARTAO = "MOTORISTA_ASSINATURA_FALHA_CARTAO",
  MOTORISTA_RENOVACAO_LEMBRETE = "MOTORISTA_RENOVACAO_LEMBRETE",
  MOTORISTA_RENOVACAO_URGENCIA = "MOTORISTA_RENOVACAO_URGENCIA",
  MOTORISTA_RENOVACAO_RECUPERACAO_1 = "MOTORISTA_RENOVACAO_RECUPERACAO_1",
  MOTORISTA_RENOVACAO_RECUPERACAO_FINAL = "MOTORISTA_RENOVACAO_RECUPERACAO_FINAL",

  MOTORISTA_CONTRATO_ASSINADO = "MOTORISTA_CONTRATO_ASSINADO",
  AUTH_RECUPERACAO_SENHA = "AUTH_RECUPERACAO_SENHA",
  AUTH_SENHA_ALTERADA = "AUTH_SENHA_ALTERADA",
  MOTORISTA_CADASTRO_ADMIN = "MOTORISTA_CADASTRO_ADMIN",
  MOTORISTA_RESET_SENHA_ADMIN = "MOTORISTA_RESET_SENHA_ADMIN",
  MOTORISTA_INDICACAO_BONUS = "MOTORISTA_INDICACAO_BONUS",
  MOTORISTA_INDICACAO_CADASTRO = "MOTORISTA_INDICACAO_CADASTRO",
  ...
  MOTORISTA_COBRANCAS_HOJE = "MOTORISTA_COBRANCAS_HOJE",
  MOTORISTA_EQUIPE_CADASTRO = "MOTORISTA_EQUIPE_CADASTRO",
  MOTORISTA_EQUIPE_RESET_SENHA = "MOTORISTA_EQUIPE_RESET_SENHA",
  MOTORISTA_EQUIPE_STATUS_ALTERADO = "MOTORISTA_EQUIPE_STATUS_ALTERADO",
  MOTORISTA_NOVO_PRE_CADASTRO = "MOTORISTA_NOVO_PRE_CADASTRO",
  MOTORISTA_AUSENCIA_REGISTRADA = "MOTORISTA_AUSENCIA_REGISTRADA",
  MOTORISTA_AUSENCIA_REMOVIDA = "MOTORISTA_AUSENCIA_REMOVIDA",

  ADMIN_NOVO_CADASTRO = "ADMIN_NOVO_CADASTRO",
  ADMIN_NOVA_ASSINATURA = "ADMIN_NOVA_ASSINATURA",
  ADMIN_ASSINATURA_CANCELADA = "ADMIN_ASSINATURA_CANCELADA",
